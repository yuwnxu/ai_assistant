        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                // Верхний контент (текст + иконка солнца)
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 100),  // ← твой отступ 100
                    SvgPicture.asset(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildAIMessage(
                            'Привет! Конечно, я с радостью помогу. Что именно тебя интересует? Расскажи подробнее, в чем заключается твой вопрос или задача.',
                            customWidth: 387,
                          ),
                          const SizedBox(height: 50),
                          _buildUserMessage(
                            'Я хочу проанализировать свой день',
                            customWidth: 250,
                          ),
                          const SizedBox(height: 50),
                          _buildAIMessage(
