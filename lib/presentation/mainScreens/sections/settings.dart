      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Center(child: ClipOval(child: Image.asset('assets/icons/user_avatar.jpg', width: 48, height: 48))),
              SizedBox(width: 10),
              SizedBox(height: 10),
              Text(
                'Имя',
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if (_selectedTone == 'Поддерживающий') SvgPicture.asset('assets/icons/check.svg', width: 10, height: 8, color: white),
                      ],
                    ),
                  ),
                ),
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if (_selectedTone == 'Аналитический') SvgPicture.asset('assets/icons/check.svg', width: 10, height: 8, color: white),
                      ],
                    ),
                  ),
                ),
              ...
              GestureDetector(
                onTap: () {
                  // TODO: выход из аккаунта -> переход на экран входа
                  navToSignIn(context);
                },
                child: Container(
                  width: 130,
